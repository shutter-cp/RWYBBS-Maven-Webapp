 ...
 <body id="box">
		...
		<div class="ui basic segment vertical main">
			<div class="ui raised very padded segment">
				<h1 class="ui header"><i class="ui red icon key"></i>版主登陆</h1>
				...
				<form action="${basePath}/moderatorLoginDo" method="post" class="ui form">
					<div class="field">
						<label>用户名</label>
						<input name="username" type="text" placeholder="用户名" value="${user.getUname()}">
					</div>
					<div class="field">
						<label>密码</label>
